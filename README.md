...
Open `dist/index.html` in a browser, or serve the `dist` directory with any static HTTP server.

## Files

- `dist/index.html` — page content and mesh diagrams.
- `dist/styles.css` — monochrome theme, responsive layouts and reduced-motion support.
- `dist/site.js` — mobile navigation behavior and footer year.
